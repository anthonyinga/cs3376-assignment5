//Disclaimer: Not all original code
//some code referenced by an anonymous submission on stackoverflow.com
//Anthony Inga
//4/7/2017
//CS 3376
...
int main(int argc, char **argv)
{
  ...
  if (fork() == 0)
  {
    ...
    //execute the program to check if process is executable
